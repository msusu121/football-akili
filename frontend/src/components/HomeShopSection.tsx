...
// DROP-IN REPLACEMENT
//
// Kit showcase for homepage — shows selected jersey with
// HOME / AWAY / THIRD vertical tabs.
// Clicking CTA navigates to /shop?kit=home (or away/third)
// so ShopClient filters and shows sizes/pricing.
//
...
export function HomeShopSection({
  ...
  // Build the correct link: /shop?kit=home (not /shop/slug)
  const kitParam = (active?.kitType || tab).toLowerCase();
